...
class ProductUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'fk_purchased_currency_id' => 'required|exists:regions,id',
            ...
            'variants.*.fk_varopt_1_unit_id' => 'nullable|exists:variant_option_units,id',
            ...
            'variants.*.fk_varopt_2_unit_id' => 'nullable|exists:variant_option_units,id',
            ...
            'variants.*.purchased_price' => array('regex:/^[0-9]+(\.[0-9][0-9]?)?$/', 'required'),
